    ...
    return (
        ...
        >
            ...
            <Box sx={{
                ...
                {gameInfo.gameOver ? (
                    <Display gameOver={gameInfo.gameOver} text="Game Over" />
                ) : (
                    <div>
                        <Display text={`Player: ${gameInfo.playerName}`} />
                        <Display text={`Score: ${gameInfo.score}`} />
                        <Display text={`rows: ${gameInfo.rows}`} />
                        <Display text={`Level: ${gameInfo.level}`} />
                        <Display text={`Key: ${gameInfo.keyCode}`} />
                    </div>
                )}
            </Box>
        </Box>
